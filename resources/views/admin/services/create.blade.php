...
@section('title', 'Create Service | CodeCraft Admin')
...
@section('content')
    ...
    <div class="table-card mb-4" style="border-radius: 16px; overflow: visible;">
        <div class="table-header" style="padding: 2rem;">
            <div>
                <h2 class="table-title mb-1" style="font-size: 1.75rem;">Create New Service</h2>
                <p style="color: #64748b; margin: 0;">Add a new service to your offerings</p>
            </div>
                    ...
                    <div style="padding: 2rem;">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                ...
                                rows="5" 
                                required
                                style="border-radius: 12px; border: 1.5px solid #e2e8f0;">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="table-card mb-4">
                    ...
                    <div style="padding: 2rem;">
                        ...
                        <textarea class="form-control @error('features_input') is-invalid @enderror" 
                            ...
                            style="border-radius: 12px; border: 1.5px solid #e2e8f0; font-family: 'Courier New', monospace;">{{ old('features_input') }}</textarea>
                    ...
                    <div style="padding: 2rem;">
                        ...
                        <div class="mb-0">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                ...
                                rows="3"
                                style="border-radius: 12px; border: 1.5px solid #e2e8f0;">{{ old('meta_description') }}</textarea>
