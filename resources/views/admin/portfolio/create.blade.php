...
@section('content')
    ...
    <form action="{{ route('admin.portfolio.store') }}" method="POST" id="projectForm">
        @csrf
        <div class="row">
            <div class="col-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                required placeholder="e.g. E-commerce Platform Redesign">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="project_type" id="project_type" class="form-control"
                                    value="{{ old('project_type') }}" required placeholder="e.g. Web Development">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="challenge" id="challenge" rows="4"
                                class="form-control">{{ old('challenge') }}</textarea>
                        </div>

                        <div class="form-group mb-4">
                            <label class="form-label" for="solution">The Solution</label>
                            <textarea name="solution" id="solution" rows="4"
                                class="form-control">{{ old('solution') }}</textarea>
                        </div>

                        <div class="form-group mb-4">
                            <label class="form-label" for="result">The Result</label>
                            <textarea name="result" id="result" rows="4" class="form-control">{{ old('result') }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" id="tech-input" class="form-control"
                                    placeholder="Add a technology (e.g. Laravel, React)">
                                <button type="button" id="add-tech-btn" class="btn btn-secondary">Add</button>
                            </div>
                            <div id="hidden-tech-inputs"></div>
                        </div>
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const hiddenInputs = document.getElementById('hidden-tech-inputs');
                ...
                document.getElementById('cover-upload').onchange = function (e) {
                    ...
                    fetch('{{ route("admin.portfolio.upload-media") }}', {
                        method: 'POST',
                        body: formData
                    })
                        .then(res => res.json())
