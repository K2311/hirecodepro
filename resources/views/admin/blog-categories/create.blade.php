...
@section('title', 'Create Blog Category | CodeCraft Studio')
                    ...
                    <form action="{{ route('admin.blog-categories.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-input-premium @error('name') is-invalid @enderror"
                                value="{{ old('name') }}" required placeholder="e.g. Technology">
                            @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-4">
                            <label class="form-label small text-uppercase fw-bold text-muted ls-1 mb-2">Slug
                                (Optional)</label>
                        ...
                        <div class="form-check form-switch mb-4 d-flex align-items-center gap-3 ps-0">
                            <input class="form-check-input ms-0" type="checkbox" name="is_active" value="1" checked
                                id="statusSwitch" style="width: 2.8rem; height: 1.4rem;">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary rounded-pill px-4 py-2 fw-bold">Create
                                Category</button>
