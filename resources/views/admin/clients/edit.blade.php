...
@section('page-title', 'Modify Client Profile')

@section('content')
    <div class="container-fluid p-0">
        <div class="page-header mb-4 d-flex justify-content-between align-items-center">
            <div>
                <h1 class="fw-bold"><i class="fas fa-user-edit me-2 text-primary"></i>Update Profile</h1>
                <p class="text-muted">Currently modifying: <strong>{{ $client->full_name }}</strong> </p>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('admin.clients.show', $client) }}"
                    class="btn btn-outline-primary rounded-pill px-4 border shadow-sm">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-icon-wrapper">
                                        ...
                                        <input type="text" name="full_name"
                                            ...
                                            placeholder="John Doe" value="{{ old('full_name', $client->full_name) }}"
                                            required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-icon-wrapper">
                                        ...
                                        <input type="email" name="email"
                                            ...
                                            placeholder="john@example.com" value="{{ old('email', $client->email) }}"
                                            required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-icon-wrapper">
                                        ...
                                        <input type="text" name="company" class="form-input-premium ps-5"
                                            placeholder="Acme Corp" value="{{ old('company', $client->company) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-icon-wrapper">
                                        ...
                                        <input type="text" name="position" class="form-input-premium ps-5"
                                            placeholder="Project Manager" value="{{ old('position', $client->position) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="notes" class="form-input-premium min-h-120"
                                        placeholder="Background information, special requirements, or specific context about this client...">{{ old('notes', $client->notes) }}</textarea>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-check form-switch-premium">
                                        <input class="form-check-input-premium" type="checkbox" name="is_subscribed"
                                            id="is_subscribed" value="1" {{ old('is_subscribed', $client->is_subscribed) ? 'checked' : '' }}>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-icon-wrapper">
                                        ...
                                        <input type="text" name="phone" class="form-input-premium ps-5"
                                            placeholder="+1 (555) 000-0000" value="{{ old('phone', $client->phone) }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-icon-wrapper">
                                        ...
                                        <input type="text" name="country" class="form-input-premium ps-5"
                                            placeholder="United States" value="{{ old('country', $client->country) }}">
                                    </div>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="premium-card border-0 shadow-sm mb-4 bg-light-gradient">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="status" id="status_lead" value="lead" {{ old('status', $client->status) == 'lead' ? 'checked' : '' }}>
                                <label class="btn btn-outline-warning rounded-pill-start py-2"
                                    for="status_lead">LEAD</label>

                                <input type="radio" class="btn-check" name="status" id="status_active" value="active" {{ old('status', $client->status) == 'active' ? 'checked' : '' }}>
                                <label class="btn btn-outline-success py-2" for="status_active">ACTIVE</label>

                                <input type="radio" class="btn-check" name="status" id="status_inactive" value="inactive" {{ old('status', $client->status) == 'inactive' ? 'checked' : '' }}>
                                <label class="btn btn-outline-secondary rounded-pill-end py-2"
                                    for="status_inactive">ARCHIVE</label>
                            </div>
                            <p class="small text-muted mt-3 mb-0">Record history: Profile generated
                                {{ $client->created_at->diffForHumans() }}</p>
                        </div>
                    </div>

                    <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill shadow-lg fw-bold fs-5">
                        <i class="fas fa-check-circle me-2"></i> Update Client Record
                    </button>
                </div>
            </div>
        </form>
