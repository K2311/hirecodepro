...
@section('content')
    ...
    <form action="{{ route('admin.products.update', $product) }}" method="POST" id="productForm" class="product-form"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('full_description') is-invalid @enderror"
                                ...
                                placeholder="Detailed product description, features, etc...">{{ old('full_description', $product->full_description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('features') is-invalid @enderror" id="features"
                                name="features" rows="4"
                                placeholder="List key features (one per line or comma-separated)...">{{ old('features', is_array($product->features) ? implode("\n", $product->features) : $product->features) }}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('license_type') is-invalid @enderror"
                                        ...
                                        <option value="single_project" {{ old('license_type', $product->license_type) === 'single_project' ? 'selected' : '' }}>Single Project
                                        </option>
                                        <option value="multiple_projects" {{ old('license_type', $product->license_type) === 'multiple_projects' ? 'selected' : '' }}>Multiple
                                            Projects</option>
                                        <option value="enterprise" {{ old('license_type', $product->license_type) === 'enterprise' ? 'selected' : '' }}>Enterprise</option>
                                        <option value="personal" {{ old('license_type', $product->license_type) === 'personal' ? 'selected' : '' }}>Personal</option>
                                        <option value="commercial" {{ old('license_type', $product->license_type) === 'commercial' ? 'selected' : '' }}>Commercial</option>
                                    </select>
                                    @error('license_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('license_terms') is-invalid @enderror" id="license_terms"
                                name="license_terms" rows="3"
                                placeholder="Detailed license terms and conditions...">{{ old('license_terms', $product->license_terms) }}</textarea>
                            @error('license_terms')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('product_type') is-invalid @enderror"
                                        ...
                                        <option value="code" {{ old('product_type', $product->product_type) === 'code' ? 'selected' : '' }}>Code</option>
                                        <option value="template" {{ old('product_type', $product->product_type) === 'template' ? 'selected' : '' }}>Template</option>
                                        <option value="api" {{ old('product_type', $product->product_type) === 'api' ? 'selected' : '' }}>API</option>
                                        <option value="plugin" {{ old('product_type', $product->product_type) === 'plugin' ? 'selected' : '' }}>Plugin</option>
                                        <option value="tool" {{ old('product_type', $product->product_type) === 'tool' ? 'selected' : '' }}>Tool</option>
                                        <option value="ebook" {{ old('product_type', $product->product_type) === 'ebook' ? 'selected' : '' }}>Ebook</option>
                                    </select>
                                    @error('product_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tech_stack') is-invalid @enderror"
                                id="tech_stack_input" value="" placeholder="e.g., Laravel, React, Node.js">
                            <small class="form-text text-muted">Press Enter to add multiple technologies</small>
                            <div id="tech-stack-tags" class="mt-2"></div>
                            @error('tech_stack')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            @error('tech_stack.*')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('dependencies') is-invalid @enderror" id="dependencies"
                                name="dependencies" rows="3"
                                placeholder="List required dependencies, frameworks, libraries...">{{ old('dependencies', is_array($product->dependencies) ? implode("\n", $product->dependencies) : $product->dependencies) }}</textarea>
                            @error('dependencies')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('requirements') is-invalid @enderror" id="requirements"
                                ...
                                placeholder="Minimum system requirements, PHP version, etc...">{{ old('requirements', $product->requirements) }}</textarea>
                            @error('requirements')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('demo_url') is-invalid @enderror"
                                        id="demo_url" name="demo_url" value="{{ old('demo_url', $product->demo_url) }}"
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="cover_image_url" id="cover_image_url"
                                    value="{{ old('cover_image_url', $product->cover_image_url) }}"
                            ...
                            <div id="cover-dropzone" class="media-dropzone p-5 text-center mb-3">
                                ...
                                <p class="mb-3"><button type="button" class="btn btn-link p-0"
                                        onclick="document.getElementById('cover-file-input').click(); return false;">or
                                        browse files</button></p>
                            ...
                            <div id="cover-preview" class="d-none">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-sm btn-outline-danger" id="remove-cover-btn"
                                        onclick="removeCover(); return false;">
                        ...
                        <div>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="gallery-url-input"
                                    placeholder="Add media by URL">
                            ...
                            <div id="gallery-dropzone" class="media-dropzone p-5 text-center mb-4">
                                ...
                                <p class="mb-3"><button type="button" class="btn btn-link p-0"
                                        onclick="document.getElementById('gallery-file-input').click(); return false;">or
                                        browse files</button></p>
                                <small class="d-block text-muted">Supported: JPG, PNG, GIF, MP4, WebM (multiple files
                                    allowed)</small>
                                <input type="file" id="gallery-file-input" accept="image/*,video/*" multiple
                                    style="display:none;">
                            </div>
                            ...
                            <input type="hidden" name="preview_images" id="gallery-urls-input"
                                value="{{ old('preview_images', $product->preview_images ? json_encode($product->preview_images) : '[]') }}">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Leave empty to publish immediately when status is
                                active</small>
                            @error('published_at')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="is_on_sale" name="is_on_sale" value="1" {{ old('is_on_sale', $product->is_on_sale) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                ...
                                maxlength="300">{{ old('meta_description', $product->meta_description) }}</textarea>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('changelog') is-invalid @enderror" id="changelog"
                                name="changelog" rows="4"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // ============================================
            // TECHNOLOGY STACK HANDLER
            // ============================================
            const techStackInput = document.getElementById('tech_stack_input');
            const techStackTags = document.getElementById('tech-stack-tags');

            console.log('Tech Stack Input element:', techStackInput);
            console.log('Tech Stack Tags container:', techStackTags);

            // Load existing tech stack from database
            let techStackArray = [];
            const existingTechStack = @json($product->tech_stack ?? []);
            console.log('Existing tech stack from database:', existingTechStack, 'Type:', typeof existingTechStack);

            if (existingTechStack && Array.isArray(existingTechStack)) {
                techStackArray = existingTechStack.filter(item => item !== null && item.trim() !== '');
                console.log('Tech stack array (from array):', techStackArray);
            } else if (typeof existingTechStack === 'string' && existingTechStack.trim() !== '') {
                try {
                    const parsed = JSON.parse(existingTechStack);
                    if (Array.isArray(parsed)) {
                        techStackArray = parsed.filter(item => item !== null && item.trim() !== '');
                        console.log('Tech stack array (parsed from string):', techStackArray);
                    }
                } catch (e) {
            ...
            console.log('Final techStackArray:', techStackArray);
            ...
            console.log('Calling upd        ateTechStackTags() to initialize...');
            updateTechStackTags();
            console.log('updateTechStackTags() completed. Check if tags appeared.');
            ...
            try {
                ...
                console.log('Raw gallery value from input:', rawValue);
                if (rawValue) {
                    ...
                    galleryArray = parsed.map(item => {
                        ...
                        // Skip invalid items
                        return null;
                    }).filter(item => item !== null && item.url); // Only keep valid items with URLs
                    console.log('Processed galleryArray:', galleryArray);
                }
            } catch (e) {
            ...
            // Initial render
            console.log('Rendering gallery with', galleryArray.length, 'items');
            renderGallery();
            ...
            function createMediaPreview(url, type = 'thumb') {
                ...
                // Removed fixed height/width for flex containers outside
            ...
            function renderGallery() {
                console.log('renderGallery called. Items:', galleryArray.length);
                galleryPreviews.innerHTML = '';

                if (!Array.isArray(galleryArray)) {
                    console.error('galleryArray is not an array:', galleryArray);
                    return;
                }
                ...
                galleryArray.forEach((item, idx) => {
                    try {
                        ...
                        if (!item || typeof item !== 'object' || !item.url) {
                            console.warn('Skipping invalid gallery item at index', idx, ':', item);
                            return;
                        }
                        ...
                        console.error('Error rendering gallery item at index', idx, ':', error, 'Item:', item);
                    }
                });
            ...
            function handleGalleryFiles(files) {
                ...
                Array.from(files).forEach(file => {
                    ...
                    fetch('{{ route("admin.products.upload-media") }}', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': token,
            ...
            const oldCoverImage = @json(old('cover_image_url', $product->cover_image_url));
            if (oldCoverImage && oldCoverImage.trim() !== '') {
                // coverInput.value is already set by Blade
